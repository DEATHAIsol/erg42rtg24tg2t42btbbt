...
These Terms of Use provide the terms and conditions under which you, whether personally or on behalf of an entity ("you" or "your"), are permitted to use, interact with or otherwise access the Interfaces or Features provided by ProbioMarkets B.V. ("the Company," "ProbioMarkets" "we," "us," or "our"). These Terms of Use, together with any documents and additional terms or policies that are appended hereto or that expressly incorporate these Terms of Use by reference as well as our Privacy Policy (collectively, the "Terms"), constitute a binding agreement between you and us. These Terms are applicable to (i) all content, informational functionality, and information features (the "Content Features") available on ProbioMarkets.com (the "Site") and any other site to which the Terms are posted (each, as applicable, an "Interface") and (ii) software, including but not limited to the blockchain-based, smart contract protocol (the "Protocol") known as ProbioMarkets (hereinafter, the "Platform"), that may be available to users by connecting their self-hosted wallets via an Interface, including but not limited to the Site (the "Technology Features" and together with the Content Features, the "Features"). 
...
USE OF THE SITE, PLATFORM OR TECHNOLOGY FEATURES FOR TRADING IS NOT PERMITTED BY PERSONS OR ENTITIES WHO RESIDE IN, ARE LOCATED IN, ARE INCORPORATED IN, HAVE A REGISTERED OFFICE IN, OR HAVE THEIR PRINCIPAL PLACE OF BUSINESS IN THE UNITED STATES OF AMERICA, UNITED KINGDOM, FRANCE, ONTARIO, SINGAPORE, POLAND, THAILAND, AUSTRALIA, BELGIUM, TAIWAN, OR ANY OTHER RESTRICTED TERRITORY AS DEFINED BELOW (ANY SUCH PERSON OR ENTITY FROM THESE JURISDICTIONS, A "RESTRICTED PERSON"). ADDITIONALLY, USE OF THE SITE, PLATFORM OR TECHNOLOGY FEATURES FOR TRADING IS NOT PERMITTED BY PERSONS OR ENTITIES (I) ON BEHALF OF ANY RESTRICTED PERSON(S) OR (II) DIRECTED, COORDINATED OR CONTROLLED BY ANY RESTRICTED PERSON (ANY SUCH PERSON OR ENTITY ALSO SHALL BE CONSIDERED A RESTRICTED PERSON). THERE ARE NO EXCEPTIONS; THEREFORE, IF YOU ARE A RESTRICTED PERSON, THEN DO NOT ATTEMPT TO USE THE SITE, PLATFORM OR ANY OF THE TECHNOLOGY FEATURES TO TRADE. USE OF A VIRTUAL PRIVATE NETWORK ("VPN") OR ANY SIMILAR TOOL TO ATTEMPT TO OR TO CIRCUMVENT THE RESTRICTIONS SET FORTH HEREIN IS STRICTLY PROHIBITED. ANY PERSON IN VIOLATION OF THESE TERMS MAY HAVE THEIR WALLETS PLACED IN CLOSE-ONLY MODE AND BE PROHIBITED FROM ACCESSING THE TECHNOLOGY FEATURES IN OUR SOLE DISCRETION.

The Site and Features

Description of the Site and Features

The Site contains different functionality – one part provides information about global news and events (the "Information Site"), while another part contains a feature that allows users to send messages to the Solana blockchain network in an entirely self-directed manner in order to engage in trades for certain event-based contracts (the "Contracts").

Neither the Company operates a cryptoasset or derivatives exchange platform or offer trade execution or clearing services and, therefore, has no control concerning your transactions using the Features. The pricing information provided on the Site relating to Contracts does not represent an offer, a solicitation of an offer, or any advice regarding, or recommendation to enter into, a transaction with the Company. Even when the Site appears to be dynamic (e.g., updating or providing new displays when you – on your own accord – provide certain information), at no time is the Company taking action directed by you or on your behalf.

In addition, if you click the "Connect Wallet" feature on the Site such that your self-hosted cryptocurrency wallet ("Wallet") is able to provide information to be transmitted to a blockchain network or other blockchain-based application, you should note that the Company (i) is not involved in providing or transmitting any such information to networks, (ii) cannot transmit any information to networks or otherwise assist in any transaction, (iii) never has access to and cannot control or provide guarantees relating to your Wallet and (iv) has no authority over and does not take possession or custody of your cryptoassets at any time, except as otherwise discussed herein. This also means that the Company is unable to assist with transactions: please be vigilant in interacting with any immutable blockchain technology.

Further, the Company does not own or control any of the deployed Contracts or the underlying software through which blockchain networks are formed or the Protocol is deployed. In general, the software underlying blockchain networks, including the Solana network, is open source, such that anyone can use, copy, modify, and distribute it.
...
The Company does not own or control the Protocol or the Solana blockchain network on which the Protocol has been deployed. The Company is not responsible for the operation of the underlying Solana blockchain network, and the Company makes no guarantee of the network's functionality, security, or availability. The Company has no ability in any way to control, maintain, provide, operate, or improve the blockchain network underlying the Protocol nor the activity or data thereon. The Company is not responsible for the activities of persons or entities who develop or use applications or who validate or verify transactions or other operations related to blockchain networks operated by third parties. The Company cannot control how blockchain networks operated by third parties market their blockchain networks and users should not assume any blockchain networks operated by third parties are affiliated with the Company.

All transactions broadcast to the applicable blockchain network via your Wallet may require the payment of non-refundable network transaction fees, which shall be borne entirely by you. We do not effectuate, facilitate or control any transactions initiated via the Platform, and the Company will not be responsible for the result of any transactions, including but not limited to failed, inadvertent, or fraudulent transactions that may result in loss of funds or transaction fees or any other loss or harm to you.
...
We reserve the right, in our sole discretion, to modify, substitute, eliminate, restrict access to, or add to the Site, any other Interface, or any Feature at any time and from time to time, with or without notice to you, including deleting or otherwise materially modifying content and information. We may, at our sole discretion, from time to time and with or without prior notice to you, modify, suspend or disable (temporarily or permanently) the Site, any other Interface, or the Features, in whole or in part, for any reason whatsoever, including, without limitation, to only allow open contracts to be closed.

Upon termination of your access, your right to use the Site, any other Interface, or the Features will immediately cease. We will not be liable for any losses suffered by you resulting from any modification to any Site, any other Interface, or Features or from any modification, suspension, or termination, for any reason, of your access to all or any portion of the Site, any other Interface, or the Features.

The Site, any other Interface, and the Features may evolve, which means the Company may apply changes, replace, or discontinue (temporarily or permanently) the Site, any other Interface, or the Features at any time in its sole discretion.
...
Financial Risks. Use of the Features, in particular entering into Contracts on the Platform, may carry financial risk. You acknowledge and understand that Contracts are inherently risky by their nature and participation in Contracts could result in the loss of the full amount supplied. Contracts such as the Contracts available on the Platform are highly experimental, risky, and volatile. Transactions entered into in connection with the Contracts are irreversible, final and there are no refunds. You acknowledge and agree that you will access and use the Site, any other Interface, and the Features, including the Contracts and the Platform, at your own risk. The risk of loss in transacting in cryptoassets using Contracts can be substantial. You should, therefore, carefully consider whether such transactions are suitable for you in light of your circumstances and financial resources. Further, such risks and adverse outcomes may be exacerbated when leverage and/or derivative products are used and we may, at any time and in our sole discretion, elect to suspend or terminate our support of any or all supported Contracts.

BY USING THE PLATFORM TO TRADE AND ENTER INTO CONTRACTS, YOU CAN LOSE UP TO THE ENTIRE AMOUNT OF THE CRYPTOASSETS SUPPLIED TO THE CONTRACT.

Contract Resolution. You acknowledge and understand that the Company is not involved in nor responsible for the resolution of any Contracts displayed on the Platform. You further acknowledge and understand that all Contracts displayed on the Platform are resolved according to a Contract's pre-defined rules through decentralized oracle mechanisms on the Solana blockchain. You acknowledge and agree that the Company is not responsible for any disputes related to the resolution of any Contracts and that any such disputes shall be made through the prescribed process through the applicable oracle system.
