...
The Site contains different functionality. One part provides information about global news and events (the "Information Site"), while another part contains a feature that allows users to send messages to the Robinhood Chain network in an entirely self-directed manner in order to engage in trades for certain event-based contracts (the "Contracts").
